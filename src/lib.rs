// src/lib.rs
/*
 * Core library for ContractService
 */
...
#[derive(Debug)]
pub struct ContractServiceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ContractServiceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ContractService processing");
    
    let mut processor = ContractServiceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ContractServiceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ContractServiceProcessor::new(false);
